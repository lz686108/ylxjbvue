      ...
      <table class="table">
        ...
        <tbody>
          <tr v-for="(item, index) in tablelistssi" :key="index">
            ...
            <td
              :class="item.tio2 >= 0.3 ? 'mathsea' : 'mathsma'"
              style="text-align: right"
            >
              {{ item.tio2 }}
            </td>
...
export default {
  ...
  methods: {
    ...
    selectxus() {
      axios({
        method: "post",
        url: "http://localhost:40014/mpd/ylxjb/luruf/selectxubut",
        params: {},
      }).then((res) => {
    ...
    selecttableall() {
      ...
      axios({
        method: "post",
        url: "http://localhost:40014/mpd/ylxjb/luruf/selectTableBybbh",
        params: {
    ...
    selectztbbxis(gysmc) {
      (this.ztbbxxsys = []),
        axios({
          method: "post",
          url: "http://localhost:40014/mpd/ylxjb/luruf/selecttcymsj",
          params: {
            bbh: this.banbenhao,
            gysmc: gysmc,
          },
    ...
    selectzztclas() {
      ...
      // axios({
      //   method: "post",
      //   url: "http://localhost:40014/mpd/ylxjb/luruf/selecttypeofzut",
      //   params: {
      //     gysmc: this.zzgysmc,
    ...
    bzxxcx() {
      axios({
        method: "post",
        url: "http://localhost:40014/mpd/ylxjb/luruf/selectbzzxx",
        params: {},
      }).then((res) => {
        this.bbbsz = res.data;
      });
