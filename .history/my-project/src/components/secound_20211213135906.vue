  ...
  <div>
    ...
    <div class="h1">
      ...
      <div class="qhbb2">
        ...
        <div class="truenfh">
          <div class="qhbb4 fh" style="width: 7.3vw;background-color:#1D3466">
      ...
      <table class="table">
        ...
        <tbody>
          <tr v-for="(item, index) in talist" :key="index">
            ...
            <td>
              <input type="text" class="inputs" v-model="item.chemotropism" />
            </td>
            <td>
              <input type="text" class="inputs" v-model="item.crystalStock" />
            </td>
            <td>
              <input type="text" class="inputs" v-model="item.liquidFluidity" />
            </td>
            <td>
...
export default {
  ...
  methods: {
    selectalofluruf() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40010/mpd/ylxjb/luruf/selectsidall",
        params: {
    ...
    insertslurus() {
      ...
      axios({
        method: "post",
        url: "http://10.6.1.179:40010/mpd/ylxjb/luruf/insertslurus",
        params: {
    ...
    selectxus() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40010/mpd/ylxjb/luruf/selectxubut",
        params: {},
      }).then((res) => {
