      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <td style="width: 13vw">供应商</td>
            <td style="width: 4vw">合同价格</td>
            <td style="width: 4vw">有效品位</td>
            <td style="width: 4vw">有效品位<br />吨度价</td>
            <td>计划<br />兑现率</td>
            <td>实际<br />兑现率</td>
            <td>TFe</td>
            <td>CaO</td>
            ...
            <td style="width: 6vw">连晶强度（≥300N)</td>
        ...
        <tbody>
          <tr v-for="(item, index) in tablelistssi" :key="index">
            ...
            <td class="gysnames" style="width: 13vw; text-align: left">
              {{ item.gysmc }}
            </td>
      ...
      let option = {
        ...
        radar: {
          indicator: [
            ...
            { name: "P" + "(" + tats[2] + ")", max: 0.14 },
            { name: "MnO" + "(" + tats[3] + ")", max: 0.8 },
