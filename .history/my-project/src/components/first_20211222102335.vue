      ...
      <table class="table">
        ...
        <tbody>
          <tr v-for="(item, index) in tablelistssi" :key="index">
            <td>{{ 11 }}</td>
            <td class="gysnames">{{ item.gysmc }}</td>
            ...
            <td class="mathsma" style="text-align:right">{{ item.yxpwduj }}</td>
            ...
            <td class="mathsma" style="text-align:right">{{ item.shuifen }}</td>
            <td class="mathsma" style="text-align:right">{{ item.Ig }}</td>
            <td class="mathsma" style="text-align:right">{{ item.liu }}</td>
            <td style="width: 6vw;text-align:right;padding-right:0.5vw"  class="mathsma">{{ item.thxwd }}</td>
            <td style="text-align:right" class="mathsma">{{ item.ljqd }}</td>
            <td style="width: 5vw;text-align:right" class="mathsma">{{ item.yxldx }}</td>
            <td style="width: 4vw;text-align:right" class="mathsma">{{ item.zjxqd }}</td>
          </tr>
        </tbody>
      </table>
    </div>
