    ...
    <div class="xztccss" v-if="xztcslmsg">
      <div class="talstiong">
        <div class="tiontle">
          ...
          <div @click="quxtancbutas()" style="cursor: pointer">❌</div>
        </div>
        <!-- 实体按钮 -->
        <div class="centslasd">
          <div class="glonils">
            <div class="yughs">名称</div>
            <input type="text" class="inputs" style="width: 8vw" v-model="mc" />
          </div>
          <div class="glonils">
            <div class="yughs">TFe</div>
            <input
              type="text"
              class="inputs"
              style="width: 8vw"
        ...
        <div class="centslasd">
          ...
          <div class="glonils">
            <div class="yughs">P</div>
            <input type="text" class="inputs" style="width: 8vw" v-model="P" />
          </div>
          <div class="glonils">
            <div class="yughs">K2O</div>
            <input
              type="text"
              class="inputs"
              style="width: 8vw"
        ...
        <div class="centslasd">
          ...
          <div class="glonils">
            <div class="yughs">Ig</div>
            <input type="text" class="inputs" style="width: 8vw" v-model="Ig" />
          </div>
          <div class="glonils">
            <div class="yughs">S</div>
            <input type="text" class="inputs" style="width: 8vw" v-model="S" />
          </div>
        </div>

        <div
          class="qhbb4"
          style="margin-top: 3vh; margin-left: 31vw"
          @click="instyon()"
        >
          确定
        </div>
...
export default {
  ...
  methods: {
    selectbbtsalsec() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/selectbbtsalsec",
        params: {},
      }).then((res) => {
    ...
    baocunxg() {
      ...
      axios({
        method: "post",
        url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/updatebzjhcsl",
        params: {
    ...
    instyon() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/inserttghslsd",
        params: {
          mc: this.mc,
          TFe: this.TFe,
          CaO: this.CaO,
