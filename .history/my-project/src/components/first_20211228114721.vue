    ...
    <div class="histtory" v-show="histtorytcs == true">
      <div class="tcstyle">
        ...
        <div class="zbttc">
          ...
          <div class="oneblue" @click="gbzdtcs()">关闭</div>
        </div>
        <!-- 基本数据 -->
        ...
        <div class="zfks">
          ...
          <div class="leftfks">
            ...
            <div class="bzztst" style="margin-top: 0.5vh">
              <span class="busq">TFe</span>
              <span class="busq">标准</span>
            </div>
            <div class="bzztst">
              <span class="busq">SiO2</span>
              <span class="busq">标准</span>
            </div>
            <div class="bzztst">
              <span class="busq">P</span>
              <span class="busq">标准</span>
            </div>
            <div class="bzztst">
              <span class="busq">MnO</span>
              <span class="busq">标准</span>
            </div>
            <div class="bzztst">
              <span class="busq">Al2O3</span>
              <span class="busq">标准</span>
            </div>
          </div>
          <!-- 右 -->
          <div class="rightfks">
            ...
            <div class="tastbaled">
              ...
              <!-- 第二行 -->
              <div class="tommyse" id="tommyse"></div>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  mounted() {
    // arr.map((v, i) => {
    //   console.log(i, 1231231231);
    // });
    // console.log(arr, 12123);
  ...
  methods: {
    ...
    hdressmon() {
      ...
      let order = "Ⅳ";
      var tats = [];
      // tats.push(tcsjshz[0].tfe);
      // tats.push(tcsjshz[i].sio2);
      // tats.push(tcsjshz[i].Al2O3);
      // tats.push(tcsjshz[i].P);
      // tats.push(tcsjshz[i].MnO);
      // console.log(this.tcsjshz,123123);
      // this.tcsjshz.map((v, i) => {
      //   console.log(v);
      //   // tats[i] = v;
      // });
      console.log(this.tcsjshz, 111);
      let data = Object.values(this.tcsjshz);
      data.map((v, i) => {
        tats[i] = v;
      });
      console.log(tats, 456456456);
        ...
        series: [
          {
            ...
            data: [
              {
                value: [tats[6], tats[7], tats[8], tats[9], tats[10], 18000],
                areaStyle: {
                  color: "#1C5C78",
                  borderColor: "#1C5C78",
                },
    ...
    dexls() {
      ...
      let option = {
        ...
        series: [
          {
            type: "bar",
            data: [400, 400, 300, 300, 300, 400, 400, 400, 300, 400, 400, 400],
            barWidth: "10px",
            itemStyle: {
              normal: {
                color: new echarts.graphic.LinearGradient(
    ...
    opentancs(
      ...
      // console.log(this.tcsjshz, 1231231);
