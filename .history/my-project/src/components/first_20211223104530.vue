...
export default {
  ...
  methods: {
    ...
    selecttableall() {
      ...
      axios({
        ...
        for (let i = 0; i < this.tablelistssi.length; i++) {
          ...
          this.fxsjdxl.push(this.tablelistssi[i].sjdxl);
    ...
    gysysm() {
      ...
      for (let i = 0; i < tabssi.length; i++) {
        this.sechali.push(tabssi[i].this.ssexl);
      }
      console.log(this.sechali, 123);
    },
    DrawChart() {
        ...
        series: [
          {
            type: "bar",
            data: [
              5000, 2600, 1300, 1300, 1250, 1500, 5000, 2600, 1300, 1300, 1250,
              1500, 5000, 2600, 1300, 1300, 1250, 1500, 5000, 2600, 1300, 1300,
              1250, 1500, 5000, 2600,
            ],
            barWidth: "20px",
            itemStyle: {
