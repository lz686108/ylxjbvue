      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <td style="width: 4vw">合同价格</td>
            <td>有效品位</td>
            <td
              @click="list_sort('yxpwduj')"
              :class="biaotbs == 'yxpwduj' ? 'ssors' : ''"
            ...
            <td
              @click="list_sort('CaO')"
              :class="biaotbs == 'CaO' ? 'ssors' : ''"
              style="cursor: pointer"
            >
              CaO
            </td>
            <td
              @click="list_sort('sio2')"
              :class="biaotbs == 'sio2' ? 'ssors' : ''"
              style="cursor: pointer"
            >
              SiO<sub>2</sub>
            </td>
            <td
              @click="list_sort('MgO')"
              :class="biaotbs == 'MgO' ? 'ssors' : ''"
              style="cursor: pointer"
            >
              MgO
            </td>
            <td
              @click="list_sort('Al2O3')"
              :class="biaotbs == 'Al2O3' ? 'ssors' : ''"
              style="cursor: pointer"
            >
              AI<sub>2</sub>O<sub>3</sub>
            </td>
            <td
              @click="list_sort('tio2')"
              :class="biaotbs == 'tio2' ? 'ssors' : ''"
              style="cursor: pointer"
            >
              TiO2
            </td>
            ...
            <td
              @click="list_sort('K2O')"
              :class="biaotbs == 'K2O' ? 'ssors' : ''"
              style="cursor: pointer"
            >
              K2O
            </td>
            <td
              @click="list_sort('Na2O')"
              :class="biaotbs == 'Na2O' ? 'ssors' : ''"
              style="cursor: pointer"
            >
              Na2O
            </td>
            ...
            <td
              @click="list_sort('MnO')"
              :class="biaotbs == 'MnO' ? 'ssors' : ''"
              style="cursor: pointer"
            >
              MnO
            </td>
            <td
              @click="list_sort('shuifen')"
              :class="biaotbs == 'shuifen' ? 'ssors' : ''"
              style="cursor: pointer"
            >
              H2O
            </td>
            ...
            <td
              @click="list_sort('liu')"
              :class="biaotbs == 'liu' ? 'ssors' : ''"
              style="cursor: pointer"
            >
              S
            </td>
            <td style="width: 6vw" @click="list_sort('thxwd')">
              <span
                :class="biaotbs == 'thxwd' ? 'ssors' : ''"
                style="cursor: pointer"
              >
                同化性温度
              </span>
            ...
            <td @click="list_sort('ljqd')">
              <span
                :class="biaotbs == 'ljqd' ? 'ssors' : ''"
                style="cursor: pointer"
              >
                连晶强度
              </span>
            ...
            <td style="width: 5vw" @click="list_sort('yxldx')">
              <span
                :class="biaotbs == 'yxldx' ? 'ssors' : ''"
                style="cursor: pointer"
              >
                液相流动性
              </span>
            ...
            <td style="width: 4vw" @click="list_sort('zjxqd')">
              <span
                :class="biaotbs == 'zjxqd' ? 'ssors' : ''"
                style="cursor: pointer"
                >粘结相强度</span
              >
              (＞700N)
        ...
        <tbody>
          <tr v-for="(item, index) in tablelistssi" :key="index">
            ...
            <td class="mathsma" style="text-align: right; width: 4vw">
              {{ item.htjg }}
            </td>
            ...
            <td
              :class="item.tfe <= 55 ? 'mathsea' : 'mathsma'"
            ...
            <td
              :class="item.sio2 >= 8 ? 'mathsea' : 'mathsma'"
              style="text-align: right"
            >
              {{ item.sio2 }}
            </td>
            ...
            <td
              :class="item.Al2O3 >= 3 ? 'mathsea' : 'mathsma'"
              style="text-align: right"
            >
              {{ item.Al2O3 }}
            </td>
            <td
              :class="item.tio2 >= 0.1 ? 'mathsea' : 'mathsma'"
              style="text-align: right"
            >
              {{ item.tio2 }}
            </td>
            <td
              :class="item.P >= 0.1 ? 'mathsea' : 'mathsma'"
              style="text-align: right"
            >
              {{ item.P }}
            </td>
            <td
              :class="item.K2O >= 0.1 ? 'mathsea' : 'mathsma'"
              style="text-align: right"
            >
              {{ item.K2O }}
            </td>
            <td
              :class="item.Na2O >= 0.1 ? 'mathsea' : 'mathsma'"
              style="text-align: right"
            >
              {{ item.Na2O }}
            </td>
            <td
              :class="item.ZnO >= 0.1 ? 'mathsea' : 'mathsma'"
              style="text-align: right"
            >
              {{ item.ZnO }}
            </td>
            ...
            <td
              :class="item.shuifen >= 9.5 ? 'mathsea' : 'mathsma'"
              style="text-align: right"
            >
              {{ item.shuifen }}
            </td>
            ...
            <td
              :class="item.liu >= 0.5 ? 'mathsea' : 'mathsma'"
              style="text-align: right"
            >
              {{ item.liu }}
            </td>
            <td
              ...
              :class="
                item.thxwd >= 1280 || item.thxwd <= 1240 ? 'mathsea' : 'mathsma'
              "
            >
              {{ item.thxwd }}
            </td>
            <td
              style="text-align: right"
              :class="item.ljqd <= 300 ? 'mathsea' : 'mathsma'"
            >
              {{ item.ljqd }}
            </td>
            <td
              style="width: 5vw; text-align: right"
              :class="
                item.yxldx >= 1.8 || item.yxldx <= 1.2 ? 'mathsea' : 'mathsma'
              "
            >
              {{ item.yxldx }}
            </td>
            <td
              ...
              :class="item.zjxqd < 700 ? 'mathsea' : 'mathsma'"
            >
              {{ item.zjxqd }}
            </td>
            <td
...
export default {
  ...
  methods: {
    list_sort(e) {
      this.biaotbs = e;
      console.log(this.biaotbs);
      if (this.bian) {
        this.tablelistssi = this.tablelistssi.sort((a, b) => a[e] - b[e]);
        this.bian = false;
      } else {
        this.tablelistssi = this.tablelistssi.sort((a, b) => b[e] - a[e]);
        this.bian = true;
      }
    },
    threebutton(index) {
    ...
    selectxus() {
      axios({
        ...
        this.selectxulists = res.data.slice(0, 19);
    ...
    selecttableall() {
      ...
      axios({
        method: "post",
        url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/selectTableBybbh",
        params: {
          banbenh: this.banbenhao,
          pxgz: this.paixunum,
        },
      }).then((res) => {
        this.tablelistssi = this.list_sort(res.data.yxpwduj);
        console.log(this.tablelistssi);
        for (let i = 0; i < res.data.length; i++) {
          this.tablelistssi[i].gysmc = res.data[i].gysmc
            .replace("有限公司", "")
            .replace("有限责任公司", "")
            .replace("矿业", "");
        }
      ...
      let option = {
        ...
        radar: {
          indicator: [
            ...
            { name: "SiO2" + "(" + tats[1] + ")", max: 10 },
            { name: "P" + "(" + tats[2] + ")", max: 0.1 },
            { name: "MnO" + "(" + tats[3] + ")", max: 15 },
            { name: "Al2O3" + "(" + tats[4] + ")", max: 7.5 },
          ],
          name: {
            textStyle: { color: "#fff" },
          },
    ...
    selectztbbxis(gysmc) {
      (this.ztbbxxsys = []),
        axios({
          method: "post",
          url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/selecttcymsj",
          params: {
            bbh: this.banbenhao,
            gysmc: gysmc,
          },
    ...
    selectzztclas() {
      ...
      // axios({
      //   method: "post",
      //   url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/selecttypeofzut",
      //   params: {
      //     gysmc: this.zzgysmc,
      ...
      var ylmc = "";
      if (
        this.lieseletone == "TFe" ||
        this.lieseletone == "SiO2" ||
        this.lieseletone == "TiO2" ||
        this.lieseletone == "H2O" ||
        this.lieseletone == "S"
      ) {
        ylmc = "erp";
      } else {
      ...
      axios({
        method: "get",
        url:
          "http://10.6.1.111:8888/HP/web/Wholeprocess/LZ/CostPerformance/" +
          this.zzgysmc +
          "/" +
          this.lieseletone +
          "/" +
        ...
        console.log(res.data, 8941564861);
        let data = [];
        data = res.data;
        // this.zztdz
        // data.map((v, i) => {
        //   this.value_list[i] = v.val;
        //   this.timeID[i] = v.month;
        // });
        for (let i = 0; i < data.length; i++) {
          this.value_list[i] = data[i].val;
          this.timeID[i] = data[i].month;
        }
        console.log(this.value_list, 8103205615);
        this.dexls();
        this.loading1 = false;
      });
    },
    ...
    bzxxcx() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/selectbzzxx",
        params: {},
      }).then((res) => {
        this.bbbsz = res.data;
      });
