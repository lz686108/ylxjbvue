      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <td @click="list_sort('P')" :class="biaotbs == 'P' ? 'ssors' : ''">
              P
            </td>
            <td
              @click="list_sort('K2O')"
            ...
            <td style="width: 6vw" @click="list_sort('thxwd')">
              <span :class="biaotbs == 'thxwd' ? 'ssors' : ''">
                同化性温度
              </span>
              <br />(1240-1280℃）
            </td>
            <td @click="list_sort('ljqd')">
              <span :class="biaotbs == 'ljqd' ? 'ssors' : ''"> 连晶强度 </span>
              （≥300N)
            </td>
            <td style="width: 5vw" @click="list_sort('yxldx')">
              <span :class="biaotbs == 'yxldx' ? 'ssors' : ''">
                液相流动性
              </span>
              (1.2-1.8)
            </td>
            <td style="width: 4vw" @click="list_sort('zjxqd')">
              <span :class="biaotbs == 'zjxqd' ? 'ssors' : ''">粘结相强度</span>
              (＞700N)
            </td>
            <td>历史</td>
          </tr>
