      ...
      <table class="table">
        ...
        <tbody>
          <tr v-for="(item, index) in tablelistssi" :key="index">
            <td>{{ 11 }}</td>
            <td>{{ item.gysmc }}</td>
            <td class="mathsma" style="padding-right;0vw">1</td>
            <td class="mathsma">{{ item.htjg }}</td>
            <td class="mathsma">{{ item.yxpw }}</td>
            <td class="mathsma">{{ item.yxpwduj }}</td>
            <td class="mathsma">{{ item.jhdxl }}</td>
            <td class="mathsma">{{ item.sjdxl }}</td>
            <td class="mathsma">{{ item.tfe }}</td>
            <td class="mathsma">{{ item.CaO }}</td>
            <td class="mathsma">{{ item.sio2 }}</td>
            <td class="mathsma">{{ item.MgO }}</td>
            <td class="mathsma">{{ item.Al2O3 }}</td>
            <td class="mathsma">{{ item.tio2 }}</td>
            <td class="mathsma">{{ item.P }}</td>
            <td class="mathsma">{{ item.K2O }}</td>
            <td class="mathsma">{{ item.Na2O }}</td>
            <td class="mathsma">{{ item.ZnO }}</td>
            <td class="mathsma">{{ item.MnO }}</td>
            <td class="mathsma">{{ item.shuifen }}</td>
            <td class="mathsma">{{ item.Ig }}</td>
            <td class="mathsma">{{ item.liu }}</td>
            <td style="width: 6vw"  class="mathsma">{{ item.thxwd }}</td>
            <td>{{ item.ljqd }}</td>
            <td style="width: 5vw" class="mathsma">{{ item.yxldx }}</td>
            <td style="width: 4vw" class="mathsma">{{ item.zjxqd }}</td>
          </tr>
        </tbody>
      </table>
    </div>
