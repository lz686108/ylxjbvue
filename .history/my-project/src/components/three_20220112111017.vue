...
export default {
  ...
  mounted() {
    ...
    // axios({
    //   method: "post",
    //   url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/insertallofluruf",
    //   params: {
  ...
  methods: {
    ...
    updatewhbztc() {
      ...
      axios({
        method: "post",
        url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/tastedupdate",
        params: {
    ...
    insertattribute() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/insertattribute",
        params: {
    ...
    selectattributevalue() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/selectattributevalue",
        params: {},
      }).then((res) => {
    ...
    selectofluruf() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/selectofluruf",
        params: {},
      }).then((res) => {
        this.tablelists = res.data;
      });
    ...
    insertversons() {
      ...
      for (let i = 0; i < this.turnbuts.length; i++) {
        axios({
          method: "post",
          url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/insertversons",
          params: {
    ...
    quedingupdate() {
      ...
      axios({
        method: "post",
        url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/updatecontext",
        params: {
          materialname: this.wlmc,
          distributorname: this.gysmc,
          sterilise: this.lzmc,
    ...
    htjgtjtj() {
      ...
      if (this.htjgzj != "") {
        axios({
          method: "post",
          url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/inserthtjgtjia",
          params: {
      ...
      if (this.htjgjs != "") {
        axios({
          method: "post",
          url: "http://10.6.1.179:40014/mpd/ylxjb/luruf/inserthtjgjian",
          params: {
            tabli: JSON.stringify(this.tablelists),
            htjgjs: this.htjgjs,
          },
    ...
    //基本表维护页面
    jcwhbut() {
      this.$router.push({ path: "/jcwh", query: {} });
    },
  },
};
</script>
