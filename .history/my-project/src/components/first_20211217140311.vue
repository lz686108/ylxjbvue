    ...
    <div class="bbxx">
      ...
      >
        <img
          src="../assets/book.png"
          class="pic-1"
          style="width: 2vw; height: 3.5vh; margin-left: 1vw"
        />
        <div style="color: #fff; padding-left: 1vw; font-size: 1.1vw">
          矿粉性价比测算版本信息
        </div>
      </div>
      ...
      <div>
        ...
        <div class="qhbb">
          ...
          <i
            ...
            style="color: #fff; margin-right: 0.5vw"
          ></i> -->
          <select v-model="banbenhao" class="xubut">
      ...
      <table class="table">
        ...
        <tbody>
          <tr v-for="(item, index) in tablelistssi" :key="index">
            ...
            <td>1</td>
            <td>1</td>
            <td style="width: 6vw">1</td>
            <td>1</td>
            <td style="width: 5vw">1</td>
            <td style="width: 4vw">1</td>
            <td>1</td>
          </tr>
        </tbody>
      </table>
...
export default {
  ...
  methods: {
    ...
    selecttableall(){
      axios({
        method: "post",
        url: "http://localhost:40008/mpd/ylxjb/luruf/selectTableBybbh",
        params: {
