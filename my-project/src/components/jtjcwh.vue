...
export default {
  ...
  methods: {
    selectbbtsalsec() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/allinputsofjt",
        params: {},
      }).then((res) => {
    ...
    baocunxg() {
      if (this.quanxiancard != "220570" && this.quanxiancard != "217878" && this.quanxiancard != "220589" && this.quanxiancard != "219047") {
        this.$message("无修改权限");
        return;
      }
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/updatealltojtjcsj",
        params: {
    ...
    fhsyxxx() {
      this.$router.push({path: "/jtwhym", query: {}});
    },
  },
};
</script>
