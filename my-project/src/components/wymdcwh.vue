  ...
  <div>
    ...
    <div class="fh">
      ...
      <div class="ery">
        ...
        <div class="qhbb2" style="border-radius: 0.2vw">
          <div class="qhbb4" style="font-size: 0.8vw" @click="insertwymversions()">
            保存
          </div>
        </div>
        <div class="qhbb2" style="border-radius: 0.2vw">
    ...
    <div class="thres">
      <div>
        ...
        <select
          ...
          v-model="gysmc"
        >
          <option v-for="(item, index) in selectbuts.wymmc" :key="index">
            {{ item }}
          </option>
        </select>
      </div>
...
export default {
  ...
  methods: {
    qergtmi() {
      this.$router.push({path: "/lhxnwym", query: {}})
    },
    //无烟煤新增版本
    insertwymversions() {
      ...
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/insertwymversions",
        params: {
    ...
    selectattributevalue() {
      axios({
        ...
        this.gysmc = this.selectbuts.wymmc[res.data.wymmc.length - 1];
      });
    },
    //信息添加至表格中
    insertallofluruf() {
    ...
    quedingupdate() {
      ...
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/updatewymwhxg",
        params: {
          gysmc: this.gysmc,
          fkfs: this.fkfs,
          htjg: this.htjg,
        ...
        //修改之后查询表格信息
        this.updateshow = false;
        this.gysmc = this.selectbuts.wymmc[this.selectbuts.wymmc.length - 1];
        this.htjg = "";
        this.yjhl = "";
        this.$message("修改成功");
      });
    ...
    fhtursec() {
      this.$router.push({path: "/mfcs", query: {}});
    },
    xpwhtur() {
    ...
    bzwhxxy() {
      //标准维护弹窗
      this.$router.push({path: "/wymfw", query: {}})
    },
    // 标准信息查询
    bzxxcx() {
      axios({
    ...
    //基本表维护页面
    jcwhbut() {
      this.$router.push({path: "/wymjc", query: {}});
    },
    /**
     * 删除供应商
     */
