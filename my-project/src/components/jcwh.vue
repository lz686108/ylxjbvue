...
export default {
  ...
  methods: {
    selectbbtsalsec() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/selectbbtsalsec",
        params: {},
      }).then((res) => {
    ...
    baocunxg() {
      ...
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/updatebzjhcsl",
        params: {
    ...
    instyon() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/inserttghslsd",
        params: {
          mc: this.mc,
          TFe: this.TFe,
          CaO: this.CaO,
