  ...
  <div>
    ...
    <div class="xztccss" v-if="xztcslmsg">
      <div class="talstiong">
        ...
        <div
          class="qhbb4"
          style="margin-top: 3vh; margin-left: 33vw"
          @click="instyon()"
        >
          确定
        </div>
...
export default {
  ...
  methods: {
    selectbbtsalsec() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/lhxnwym",
        params: {},
      }).then((res) => {
    ...
    baocunxg() {
      ...
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/updatelhxn",
        params: {
    ...
    instyon() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/insertlhxn",
        params: {
          mc: this.mc,
          kmx: this.kmx,
          zjx: this.zjx,
