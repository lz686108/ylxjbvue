...
export default {
  ...
  methods: {
    selectjtdcxxwhwymfw() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/selectjtdcxxwhymfw",
        params: {},
      }).then((res) => {
    ...
    csbbxi() {
      ...
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/selecttocopycopyym",
        params: {
          bbh: this.banbenhao,
        },
      }).then((res) => {
    ...
    lhxntulit() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/selectlhxnlitym",
        params: {
          wz: this.ssexllhxn,
        },
      }).then((res) => {
        ...
        for (let i = 0; i < this.lhxnecha.length; i++) {
          ag.push(this.lhxnecha[i].gysmc.replace("有限责任公司", "")
            .replace("矿业", "")
            .replace("公用设施", "")
            .replace("钢铁", "")
            .replace("国际贸易","")
    ...
    svered() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/selectbehedym",
        params: {},
      }).then((res) => {
