...
export default {
  ...
  methods: {
    selectbbtsalsec() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/allinputsofjtym",
        params: {},
      }).then((res) => {
    ...
    baocunxg() {
      if (this.quanxiancard != "220570" && this.quanxiancard != "217878" && this.quanxiancard != "219047" && this.quanxiancard != "219047") {
        this.$message("无修改权限");
        return;
      }
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/updatealltojtjcsjym",
        params: {
    ...
    instyon() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/insertnesjtbzym",
        params: {
          mc: this.mc,
          TFe: this.TFe,
          CaO: this.CaO,
    ...
    fhsyxxx() {
      this.$router.push({path: "/ymdcwh", query: {}});
    },
  },
};
</script>
