...
export default {
  ...
  methods: {
    ...
    selectxus() {
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/selectxubut",
        params: {},
      }).then((res) => {
        this.selectxulists = res.data.slice(res.data.length-20, res.data.length);
    ...
    selecttableall() {
      ...
      axios({
        method: "post",
        url: "http://10.6.1.179:40018/mpd/ylxjb/luruf/selectTableBybbh",
        params: {
